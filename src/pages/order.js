        ...
        <nav class="breadcrumb-nav">
          <div class="container">
            <ul class="breadcrumb shop-breadcrumb bb-no">
              <li class="passed">
                <Link href="cart.html">فروشگاه پینگ سبد خرید </Link>
              </li>
              <li class="passed">
                <Link href="checkout.html">پرداخت </Link>
              </li>
              <li class="active">
                <Link href="order.html">سفارش کامل شد</Link>
              </li>
            </ul>
          </div>
        </nav>
          ...
          <div class="container">
            ...
            <div class="sub-orders mb-10">
              ...
              <div class="alert alert-icon alert-inline mb-5">
                ...
                <strong>یادداشت: </strong>این سفارش دارای محصولاتی از چندین
                فروشنده است. بنابراین ما این سفارش را به چند سفارش فروشنده تقسیم
                کردیم. هر سفارش به طور مستقل توسط فروشنده مربوطه انجام می شود.
              </div>
              <table class="order-subtable">
                ...
                <tbody>
                  <tr>
                    ...
                    <td class="action">
                      <Link href="order-view.html" class="btn btn-rounded">
                        نمایش{" "}
                      </Link>
                    </td>
                  </tr>
