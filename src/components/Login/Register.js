  ...
  return (
    <div className="tab-pane" id="sign-up">
      ...
      <p>
        ...
        مدیریت دسترسی به حساب شما، و برای اهداف دیگری که در ما توضیح داده شده
      ...
      <Link href="#" className="d-block mb-5 text-primary">
      ...
      <div className="form-checkbox d-flex align-items-center justify-content-between mb-5">
        ...
        <label htmlFor="remember" className="font-size-md">
          من موافقم با
          <Link href="#" className="text-primary font-size-md">
            {" "}
            سیاست حفظ حریم خصوصی{" "}
          </Link>
        </label>
